...
/**
 * Generates javascript code for processing the given language (parser and template for the meaning part)
 * @param rule Main rule for processing the language
 * @param language Grammar of the language in lifya definition format
 * @param tree_process Post-processing applied to the grammar tree obtained by lifya
 * @param name Class name of the language generated by lifya
 * @return javascript code for processing the given language (parser and template for the meaning part)
 */
function lifya( rule, language, tree_process, name = 'NonameLanguage' ){
    ...
    var code = 
      ...
      '  process(t){\n' +
      '    //@TODO: Process the derivation tree here\n' +
      '    //We just print and return the tree in string format\n' +
      '    var tree = t.toString()\n' +  
      '    console.log(tree)\n' +  
      '    return tree\n' +
      '  }\n' +
